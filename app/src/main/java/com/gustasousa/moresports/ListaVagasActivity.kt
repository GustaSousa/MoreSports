...
class ListaVagasActivity : AppCompatActivity() {
    ...
    private lateinit var empList: ArrayList<Modelo>
    ...
    private fun getEmployeesData() {
        ...
        dbRef = FirebaseDatabase.getInstance().getReference("Noticia")
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    for (empSnap in snapshot.children){
                        val empData = empSnap.getValue(Modelo::class.java)
                        empList.add(empData!!)
                    }
